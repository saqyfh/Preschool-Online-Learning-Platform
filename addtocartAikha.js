    ...
    if(cart.length==0){
        ...
        document.getElementById("cartItem").innerHTML = cart.map((items)=>
        {
            ...
            return(
                ...
                <label>Package ID:${id} <input type='hidden' name='cartProductID[]' value='${id}' readonly></label>
                <h2 style='font-size: 17px;'>RM${price}.00 <label><input type ='hidden' name='totalPrice[]' value='${price}' readonly></label></h2>`+
