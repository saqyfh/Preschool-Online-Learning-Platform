...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $dbconn->prepare("SELECT * FROM customer WHERE custID = ?");
    ...
    if ($result ->num_rows == 1 ) {
        $row = mysqli_fetch_array($result, MYSQLI_ASSOS);
    ...
    <section>
        <div class="form-box">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <?php endif; ?>
                <div class="register">
                    <p>Don't have an account? <a href="RegisterRealLatest.php">Register Now</a></p>
                </div>
            </form>
        </div>
    </section>
