...
<head>
    ...
    <title>Mathematics Videos</title>
...
<body>
    ...
    <div style="width: 80%; margin: 0 auto; text-align: right;">
        <button class="oval-button">Back</button>
			...
			<div class="center-text">MATHEMATICS</div>
			<br>
			<br>
			<div class="title">Subtraction</div>
			<div class="video-grid">
				<div class="video-card">
					<iframe src="https://www.youtube.com/embed/TGXIZIe3Nzc?controls=1" allowfullscreen></iframe>
				</div>
				<div class="video-card">
			...
			<div class="video-grid">
				<div class="video-card">
					<iframe src="https://www.youtube.com/embed/tVHOBVAFjUw?controls=1" allowfullscreen></iframe>
				</div>
				<div class="video-card">
					<iframe src="https://www.youtube.com/embed/AaxrqDuw1Xk?controls=1" allowfullscreen></iframe>
				</div>
				<div class="video-card">
					<iframe src="https://www.youtube.com/embed/gf97tXwTDe0?controls=1" allowfullscreen></iframe>
				</div>
				<div class="video-card">
					<iframe src="https://www.youtube.com/embed/WwlrbMWcTtQ?controls=1" allowfullscreen></iframe>
				</div>
			</div>
		</div>
