    ...
    <style>
        ...
        * {
        ...
        .package-image {
         ...
         .package-image.left {
            left: -50px; /* Adjust this value to position the image correctly */
            top: 67%;
...
<body>
	...
	<div class='center-text'>PACKAGE 7</div>
    ...
    <section class="packages" id="packages">
		...
		<div class="package-card">
            ...
            <img src="1.png" alt="1" class="pic">
			<br>
			<br>
            <button><a href="game.php">Click here</a></button>
        </div>
        <div class="package-card">
            <h3>Worksheets</h3>
            <img src="2.png" alt="2" class="pic">
			<br>
			<br>
            <button><a href="PrintableWorksheet.php">Click here</a></button>
        </div>
