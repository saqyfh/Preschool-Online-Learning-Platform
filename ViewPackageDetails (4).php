...
<body>
    ...
    if ($row == 0) {
        ...
        echo "<div class='center-text'>PACKAGE DETAILS</div>";
        echo "<table>";
        echo "<tr>";
        echo "<th>Package ID</th>";
        echo "<th>Package Name</th>";
        echo "<th>Package Price</th>";
        echo "<th>Package Image</th>";
        echo "<th>Options</th>";
        echo "</tr>";
        ...
        echo "<button class='oval-button'> <a href='AddPackageLatest.php'>+ Add Package</a></button>"; 
        echo "<button class='oval-button'> <a href='dashboard.php'>Close</a></button>"; 
        echo "</div>";
