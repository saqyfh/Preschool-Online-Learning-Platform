    ...
    <style>
        ...
        * {
        ...
        .package-image {
         ...
         .package-image.left {
            left: 70px; /* Adjust this value to position the image correctly */
            top: 65%;
...
<body>
	...
	<div class='center-text'>PACKAGE 4</div>
    ...
    <section class="packages" id="packages">
        <div class="package-card">
			...
			<br>
			<br>
            <button><a href="video.html">Click here</a></button>
        </div>
        <div class="package-card">
        ...
        <div class="package-image right">
            <img src="member5.png" alt="member5">
        </div>
    </section>
